  ...
  return (
    <div className="min-h-screen bg-[#fcfaff] text-slate-800 flex flex-col selection:bg-purple-200">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* 3. Right Sidebar Dock: Phone Simulator (when active) OR Right Features Menu */}
        {showMobilePreview ? (
          <aside className="shrink-0 w-[340px] p-3 border-l border-purple-100 bg-slate-50/50 flex flex-col items-center overflow-y-auto">
            <div className="sticky top-2 flex flex-col items-center">
          ...
          <aside className="p-4 border-l border-purple-100 bg-white hidden lg:flex flex-col shrink-0">
            <RightFeaturesMenu
