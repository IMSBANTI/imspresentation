export function createNewPresentation({ id, code, title, author, template = 'blank' }) {
  ...
  if (template === 'sample' || template === 'starter') {
  ...
  // DEFAULT: Clean, fresh blank presentation with 1 Title Slide!
  return {
    id: presId,
    code: presCode,
    title: presTitle,
